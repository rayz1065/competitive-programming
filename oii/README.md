...
### Regionals
- [x] Sentieri bollenti (sentieri) [url](https://training.olinfo.it/#/task/sentieri/statement)
...
### Pre-OII
- [x] Un tragitto impegnativo (A challenging route) (got) [url](https://training.olinfo.it/#/task/preoii_got/statement)
- [x] Analizza la palestra (Gym processing) (pokemongo) [url](https://training.olinfo.it/#/task/preoii_pokemongo/statement)
- [x] Esame di Aritmanzia (Arithmancy Exam) (pota) [url](https://training.olinfo.it/#/task/preoii_pota/statement)
...
### Pre-OII
- [x] Sushi variegato (yutaka) [url](https://training.olinfo.it/#/task/preoii_yutaka/statement)
- [x] Partita a Snake (snake) [url](https://training.olinfo.it/#/task/preoii_snake/statement)
- [x] Gira i pancake (pancake) [url](https://training.olinfo.it/#/task/preoii_pancake/statement)
- [ ] Sede Centrale (nodispeciali) [url](https://training.olinfo.it/#/task/preoii_nodispeciali/statement)
...
### Pre-OII
- [x] Treni (treni) [url](https://training.olinfo.it/#/task/preoii_treni/statement)
- [ ] Piccioni in migrazione (piccioni) [url](https://training.olinfo.it/#/task/preoii_piccioni/statement)
- [ ] Flow free (flow) [url](https://training.olinfo.it/#/task/preoii_flow/statement)
- [x] Grande Mago VIP (catene) [url](https://training.olinfo.it/#/task/preoii_catene/statement)
...
### Pre-OII
- [ ] Fontana del Porcellino (porcellino) [url](https://training.olinfo.it/#/task/preoii_porcellino/statement)
- [x] Incontri inaspettati II (incontri2) [url](https://training.olinfo.it/#/task/preoii_incontri2/statement)
- [ ] Dario e la Crew (crew) [url](https://training.olinfo.it/#/task/preoii_crew/statement)
- [ ] Biliardino (biliardino) [url](https://training.olinfo.it/#/task/preoii_biliardino/statement)
...
### Pre-OII
- [ ] Truffa al sushi (sushi) [url](https://training.olinfo.it/#/task/preoii_sushi/statement)
- [ ] Mascherine sporche (mascherine) [url](https://training.olinfo.it/#/task/preoii_mascherine/statement)
- [ ] Password dimenticata (account) [url](https://training.olinfo.it/#/task/preoii_account/statement)
...
### Pre-OII
- [x] Aggiornamento della macchina virtuale (vm) [url](https://training.olinfo.it/#/task/preoii_vm/statement)
- [x] Trova la permutazione (permutazione2) [url](https://training.olinfo.it/#/task/preoii_permutazione2/statement)
- [x] Evasione dall'armadio (armadio) [url](https://training.olinfo.it/#/task/preoii_armadio/statement)
- [ ] Allenamento su ChinaForces (allenamento) [url](https://training.olinfo.it/#/task/preoii_allenamento/statement)
...
### Pre-OII
- [x] Comune di Alleib (triplets) [url](https://training.olinfo.it/#/task/preoii_triplets/statement)
- [x] Insiemi nell'armadio (sets) [url](https://training.olinfo.it/#/task/preoii_sets/statement)
- [55/100] Galleria d'arte (statue) [url](https://training.olinfo.it/#/task/preoii_statue/statement)
