...
- [x] Police Patrol (patrol) [url](https://training.olinfo.it/#/task/ois_patrol/statement)
- [x] Panama Sum (panama) [url](https://training.olinfo.it/#/task/ois_panama/statement)
- [x] Monopoly Board Game (monopoly) [url](https://training.olinfo.it/#/task/ois_monopoly/statement)
- [x] Lost in Dristor 2 (dristor2) [url](https://training.olinfo.it/#/task/ois_dristor2/statement)
...
- [x] Multiplication Practice (multiplication) [url](https://training.olinfo.it/#/task/ois_multiplication/statement)
- [x] Juggling Shows (intervals) [url](https://training.olinfo.it/#/task/ois_intervals/statement)
- [ ] DinoLand Fossils (fossils) [url](https://training.olinfo.it/#/task/ois_fossils/statement)
- [ ] Formula 1 (f1) [url](https://training.olinfo.it/#/task/ois_f1/statement)
...
- [x] Police Patrol 2 (patrol2) [url](https://training.olinfo.it/#/task/ois_patrol2/statement)
- [55/100] Minimum Not Divisible (notdivisible) [url](https://training.olinfo.it/#/task/ois_notdivisible/statement)
- [x] A Magical Walks in a Magic Forest (magicforest) [url](https://training.olinfo.it/#/task/ois_magicforest/statement)
- [x] Small Keyboard (keyboard) [url](https://training.olinfo.it/#/task/ois_keyboard/statement)
- [x] Interval of XOR (intervalxor) [url](https://training.olinfo.it/#/task/ois_intervalxor/statement)
...
### Round 4
- [ ] Ancient Text (text2) [url](https://training.olinfo.it/#/task/ois_text2/statement)
- [ ] Tree Median (median) [url](https://training.olinfo.it/#/task/ois_median/statement)
- [ ] Planting trees (lrtree) [url](https://training.olinfo.it/#/task/ois_lrtree/statement)
- [ ] Lottery tickets (lottery) [url](https://training.olinfo.it/#/task/ois_lottery/statement)
- [ ] George Challenges the Dragon (gcd) [url](https://training.olinfo.it/#/task/ois_gcd/statement)
- [ ] Overtakings (g1) [url](https://training.olinfo.it/#/task/ois_g1/statement)
- [ ] To The Finals (finals2) [url](https://training.olinfo.it/#/task/ois_finals2/statement)
- [ ] Spring Carnival (colors) [url](https://training.olinfo.it/#/task/ois_colors/statement)
